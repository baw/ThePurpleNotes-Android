...
import io.brianweiser.thepurplenotes.dummy.DummyContent;
...
public class NotebookDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_notebook_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.notebook_detail)).setText(mItem.content);
        }
